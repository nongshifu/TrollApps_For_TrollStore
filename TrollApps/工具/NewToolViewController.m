...
- (void)setupUI {
    ...
    _draftButton.titleLabel.font = [UIFont systemFontOfSize:15];
    [_draftButton setTitleColor:[UIColor linkColor] forState:UIControlStateNormal];
    ...
    [_closeButton setTitleColor:[UIColor linkColor] forState:UIControlStateNormal];
...
- (BOOL)validateInputs {
    ...
    if ([self.tagsView getTags].count ==0) {
        [self showAlertWithTitle:@"提示" message:@"至少写一个标签"];
        return NO;
    }
