...
variant_for_slice()
{
  ...
  "RongIMKit.xcframework/ios-arm64_armv7")
    echo ""
    ;;
  "RongIMKit.xcframework/ios-arm64_x86_64-simulator")
    echo "simulator"
    ;;
...
install_xcframework "${PODS_ROOT}/RongCloudIM/RongCloudIM/RongIMKit.xcframework" "RongCloudIM/IMKit" "framework" "ios-arm64_armv7" "ios-arm64_x86_64-simulator"
